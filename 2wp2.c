...
// Parent process
	...
	printf("Enter a string from parent to child: ");
...
/*output
Enter a string from parent to child: malayalam
Child process received string: malayalam
The string is a palindrome.

Enter a string from parent to child: english
